...
def process_and_translate_with_gemini(raw_text, source_hint=""):
    ...
    prompt = (
        "تو مسئول تحریریه یک کانال تلگرامی پرمخاطب، جذاب و به‌روز هستی. "
        "این خبر جدید رو بخون:\n\n"
        f"\"{raw_text}\"\n\n"
        "دستورالعمل‌ها:\n"
        "1. خبر رو به فارسی کاملاً روان، عامیانه، جذاب و محاوره‌ای (مثل لحن کانال‌های تلگرامی) بازنویسی یا ترجمه کن.\n"
        "2. متن باید طوری باشه که نظر مخاطب رو جلب کنه اما بی‌طرف بمونه.\n"
        "3. کل اصل خبر رو فقط در ۱ جمله کوتاه بیان کن.\n"
        f"4. ته جمله حتما منبع رو اضافه کن (مثلاً: — به نقل از {source_hint}).\n"
        "5. هیچ ایموجی یا عبارت متفرقه‌ای اضافه نکن."
    )
